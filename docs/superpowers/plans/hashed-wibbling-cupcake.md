...
const METRA_LINE_NAMES: Record<string, string> = {
  BNSF: 'BNSF Railway', 'UP-N': 'Union Pacific North',
  'UP-NW': 'Union Pacific Northwest', 'UP-W': 'Union Pacific West',
  'MD-N': 'Milwaukee District North', 'MD-W': 'Milwaukee District West',
  RI: 'Rock Island', SWS: 'SouthWest Service',
  HC: 'Heritage Corridor', ME: 'Metra Electric', NCS: 'North Central Service',
}
```
