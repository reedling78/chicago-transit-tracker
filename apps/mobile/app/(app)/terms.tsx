    ...
    <>
      ...
      >
        ...
        <Text style={styles.lede}>
          Please read these terms before using Chicago Transit Tracker.
        </Text>
        ...
        <Section title="Overview" theme={theme}>
          ...
          <Paragraph theme={theme}>
            By using this app, you agree to these Terms of Use. If you do not agree, please do not
            use the app.
          </Paragraph>
        </Section>
        ...
        <Section title="Intellectual Property" theme={theme}>
          <Paragraph theme={theme}>
            CTA, Metra, and their respective logos, route names, and branding are trademarks of
            their respective owners. CTA ‘L’ route colors used in this app are sourced from the
            official CTA Developer Trademark Guidelines and are used solely to identify transit
            routes.
          </Paragraph>
          <Paragraph theme={theme}>
            Chicago Transit Tracker is not intended to imply any official affiliation. No CTA or
            Metra agency logos are reproduced in this app.
          </Paragraph>
        </Section>

        <Section title="External Links" theme={theme}>
          <Paragraph theme={theme}>
            This app links to official CTA and Metra websites and other third-party resources for
        ...
        <Section title="Changes to These Terms" theme={theme}>
          <Paragraph theme={theme}>
            We may update these terms at any time without prior notice. Continued use of the app
