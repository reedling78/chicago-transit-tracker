    ...
    >
      ...
      <Section title="Overview" theme={theme}>
        <Paragraph theme={theme}>
          ...
          collected when you use this app, how it is used, and your choices. We do not sell, rent,
      ...
      <Section title="Information We Collect" theme={theme}>
        ...
        <Paragraph theme={theme}>
          ...
          visited, general device type, operating system, and approximate region. Analytics data is
      ...
      <Section title="On-Device Storage" theme={theme}>
        <Paragraph theme={theme}>
          The app uses your device’s local storage (AsyncStorage) to remember your light/dark theme
          preference and your favorites list while signed out. This data stays on your device.
        </Paragraph>
      </Section>
      ...
      <Section title="How We Use Data" theme={theme}>
        ...
        <Paragraph theme={theme}>
          Profile data (email, favorites) is used only to provide the favorites feature across your
          devices. It is stored in Firebase Firestore under owner-only access rules.
        </Paragraph>
      </Section>

      <Section title="Third-Party Services" theme={theme}>
        <Paragraph theme={theme}>
          <Text style={styles.bold}>Firebase</Text> — used for authentication, profile storage, and
          serving transit data. Firebase may log standard server request data. See{' '}
          <Text
            style={styles.link}
        ...
        <Paragraph theme={theme}>
          <Text style={styles.bold}>Google Analytics</Text> — analytics provider. Data is processed
          under Google’s privacy policy at{' '}
          <Text
            style={styles.link}
      ...
      <Section title="Your Choices" theme={theme}>
        <Paragraph theme={theme}>
          ...
          session on this device. To delete your stored profile data entirely, contact us using the
          link below.
        </Paragraph>
      </Section>
