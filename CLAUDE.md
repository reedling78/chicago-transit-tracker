  ...
  mobile/
    app/
      ...
      (app)/                      Route group (group segment NOT part of URLs) holding every real screen + the Stack layout
        _layout.tsx               The Stack — shared translucent app header (AppHeaderBackground + hairline), HeaderBackButton (left), auth modal (headerless)
